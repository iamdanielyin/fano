...
class FanoTextArea extends React.PureComponent {
  render () {
    const { props } = this
    ...
    configProps.className = configProps.className ? `${configProps.className} fano-textarea` : 'fano-textarea'
    ...
    return <Input.TextArea {...defaultProps} {..._.omit(configProps, ['fieldOptions'])} />
  }
}

export default withLocale(FanoTextArea)
