...
class FanoDatePicker extends React.PureComponent {
  render () {
    ...
    if (moment.isMoment(props.value)) {
      ...
      const format = _.get(configProps, 'format', 'YYYY-MM-DD')
    ...
    return <DatePicker {...defaultProps} {..._.omit(configProps, ['fieldOptions'])} />
  }
}

export default withLocale(FanoDatePicker)
